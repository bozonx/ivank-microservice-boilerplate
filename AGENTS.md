...
- Stack: TypeScript, NestJS, Fastify, Pino, Docker.
- This repository is the reference implementation for the fleet. Changes to shared wiring land
  here first, then roll out to the other services.
